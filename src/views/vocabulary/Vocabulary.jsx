  ...
  vocabularies: [
    ...
    },
    {
      ...
      examples: [
        {
          id: 2,
          sentence: "The receptionist accepted the pack age from the courier age from the courier.",
...
export default function Vocabulary() {
  ...
  {vocab.meaning}
          ...
          <PaginationButtons pagination={data.pagination} onPageChange={handleChangePage} sx={{ mt: 4 }}/>
      </Container>
      <Footer />
    </Stack>
  );
